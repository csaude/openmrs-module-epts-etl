create database etl_demo_with_transformation_src_db;

use etl_demo_with_transformation_src_db;
...
INSERT INTO etl_demo_with_transformation_src_db.person (id,full_name,uuid) VALUES
...
INSERT INTO etl_demo_with_transformation_src_db.address (person_id,full_address,creation_date,uuid) VALUES
...
create database etl_demo_with_transformation_dst_db;

CREATE TABLE `etl_demo_with_transformation_dst_db`.`person_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `full_name` varchar(250) NOT NULL,
  `full_address` varchar(500) NOT NULL,
