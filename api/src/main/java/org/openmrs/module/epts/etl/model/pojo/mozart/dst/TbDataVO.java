...
public class TbDataVO extends AbstractDatabaseObject implements DatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterUuid, this.encounterDate, this.tbSymptom, this.symptomFever, this.symptomWeightLoss, this.symptomNightSweat, this.symptomCough, this.symptomAsthenia, this.symptomTbContact, this.symptomAdenopathy, this.tbDiagnose, this.tbTreatment, this.tbTreatmentDate, this.formId, this.encounterType, this.patientUuid, this.createdDate, this.changeDate, this.locationUuid, this.sourceDatabase};		return params; 
	} 
 
	@JsonIgnore
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO tb_data(id, encounter_uuid, encounter_date, tb_symptom, symptom_fever, symptom_weight_loss, symptom_night_sweat, symptom_cough, symptom_asthenia, symptom_tb_contact, symptom_adenopathy, tb_diagnose, tb_treatment, tb_treatment_date, form_id, encounter_type, patient_uuid, created_date, change_date, location_uuid, source_database) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.encounterUuid, this.encounterDate, this.tbSymptom, this.symptomFever, this.symptomWeightLoss, this.symptomNightSweat, this.symptomCough, this.symptomAsthenia, this.symptomTbContact, this.symptomAdenopathy, this.tbDiagnose, this.tbTreatment, this.tbTreatmentDate, this.formId, this.encounterType, this.patientUuid, this.createdDate, this.changeDate, this.locationUuid, this.sourceDatabase};		return params; 
	} 
