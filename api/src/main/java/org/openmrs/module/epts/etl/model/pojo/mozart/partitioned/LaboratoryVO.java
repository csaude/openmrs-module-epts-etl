...
public class LaboratoryVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO laboratory(lab_test_id, request, order_date, sample_collection_date, result_report_date, result_qualitative_id, result_numeric, result_units, result_comment, specimen_type_id, labtest_uuid, form_id, encounter_type, patient_uuid, created_date, change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	}
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.labTestId, this.request, this.orderDate, this.sampleCollectionDate, this.resultReportDate,
		        this.resultQualitativeId, this.resultNumeric, this.resultUnits, this.resultComment, this.specimenTypeId,
		        this.labtestUuid, this.formId, this.encounterType, this.patientUuid, this.createdDate, this.changeDate,
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.encounterUuid, this.encounterDate, this.labTestId, this.request, this.orderDate,
		        ...
		        this.resultUnits, this.resultComment, this.specimenTypeId, this.labtestUuid, this.formId, this.encounterType,
	...
	public String getUpdateSQL() {
		return "UPDATE laboratory SET encounter_uuid = ?, encounter_date = ?, lab_test_id = ?, request = ?, order_date = ?, sample_collection_date = ?, result_report_date = ?, result_qualitative_id = ?, result_numeric = ?, result_units = ?, result_comment = ?, specimen_type_id = ?, labtest_uuid = ?, form_id = ?, encounter_type = ?, patient_uuid = ?, created_date = ?, change_date = ?, location_uuid = ?, source_database = ? WHERE encounter_date = ?  AND encounter_uuid = ? ";
	}
	
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.labTestId) + "," + (this.request) + ","
