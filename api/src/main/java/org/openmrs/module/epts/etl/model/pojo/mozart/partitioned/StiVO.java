...
public class StiVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO sti(sti_concept_id, sti_value, sti_uuid, form_id, encounter_type, patient_uuid, created_date, encounter_date, change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	}
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.stiConceptId, this.stiValue, this.stiUuid, this.formId, this.encounterType,
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.encounterUuid, this.stiConceptId, this.stiDate, this.stiValue, this.stiUuid, this.formId,
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.encounterUuid, this.stiConceptId, this.stiDate, this.stiValue, this.stiUuid, this.formId,
		        this.encounterType, this.patientUuid, this.createdDate, this.encounterDate, this.changeDate,
		        this.locationUuid, this.sourceDatabase, this.encounterUuid, this.stiDate };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE sti SET encounter_uuid = ?, sti_concept_id = ?, sti_date = ?, sti_value = ?, sti_uuid = ?, form_id = ?, encounter_type = ?, patient_uuid = ?, created_date = ?, encounter_date = ?, change_date = ?, location_uuid = ?, source_database = ? WHERE encounter_uuid = ?  AND sti_date = ? ";
	}
	
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.stiConceptId) + "," + (this.stiValue) + ","
		        + (this.stiUuid != null ? "\"" + utilities.scapeQuotationMarks(stiUuid) + "\"" : null) + "," + (this.formId)
		        + "," + (this.encounterType) + ","
