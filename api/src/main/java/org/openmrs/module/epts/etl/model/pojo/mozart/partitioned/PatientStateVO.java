...
public class PatientStateVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public void load(ResultSet rs) throws SQLException {
		...
		if (rs.getObject("program_id") != null)
			this.programId = rs.getInt("program_id");
		this.programEnrollmentDate = rs.getTimestamp("program_enrollment_date") != null
		        ? new java.util.Date(rs.getTimestamp("program_enrollment_date").getTime())
		        : null;
		this.programCompletedDate = rs.getTimestamp("program_completed_date") != null
		        ? new java.util.Date(rs.getTimestamp("program_completed_date").getTime())
		        : null;
		...
		this.enrollmentUuid = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("enrollment_uuid") != null ? rs.getString("enrollment_uuid").trim() : null);
		...
		if (rs.getObject("source_id") != null)
			this.sourceId = rs.getInt("source_id");
		if (rs.getObject("state_id") != null)
			this.stateId = rs.getInt("state_id");
		this.stateDate = rs.getTimestamp("state_date") != null ? new java.util.Date(rs.getTimestamp("state_date").getTime())
		        : null;
		this.createdDate = rs.getTimestamp("created_date") != null
		        ? new java.util.Date(rs.getTimestamp("created_date").getTime())
		        : null;
		this.stateUuid = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("state_uuid") != null ? rs.getString("state_uuid").trim() : null);
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.patientUuid, this.programId, this.programEnrollmentDate, this.programCompletedDate,
		        this.locationUuid, this.enrollmentUuid, this.encounterUuid, this.sourceId, this.stateId, this.stateDate,
		        this.createdDate, this.stateUuid, this.sourceDatabase };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.id, this.patientUuid, this.programId, this.programEnrollmentDate, this.programCompletedDate,
		        this.locationUuid, this.enrollmentUuid, this.encounterUuid, this.sourceId, this.stateId, this.stateDate,
		        this.createdDate, this.stateUuid, this.sourceDatabase };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.id, this.patientUuid, this.programId, this.programEnrollmentDate, this.programCompletedDate,
		        this.locationUuid, this.enrollmentUuid, this.encounterUuid, this.sourceId, this.stateId, this.stateDate,
		        this.createdDate, this.stateUuid, this.sourceDatabase, this.id };
		return params;
	}
	...
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.patientUuid != null ? "\"" + utilities.scapeQuotationMarks(patientUuid) + "\"" : null) + ","
		        + (this.programId) + ","
		        + (this.programEnrollmentDate != null
		                ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(programEnrollmentDate) + "\""
		                : null)
		        + ","
		        + (this.programCompletedDate != null
		                ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(programCompletedDate) + "\""
		                : null)
		        + "," + (this.locationUuid != null ? "\"" + utilities.scapeQuotationMarks(locationUuid) + "\"" : null) + ","
		        + (this.enrollmentUuid != null ? "\"" + utilities.scapeQuotationMarks(enrollmentUuid) + "\"" : null) + ","
		        + (this.encounterUuid != null ? "\"" + utilities.scapeQuotationMarks(encounterUuid) + "\"" : null) + ","
		        + (this.sourceId) + "," + (this.stateId) + ","
		        + (this.stateDate != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(stateDate) + "\"" : null)
		        + ","
		        + (this.createdDate != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(createdDate) + "\"" : null)
		        + "," + (this.stateUuid != null ? "\"" + utilities.scapeQuotationMarks(stateUuid) + "\"" : null) + ","
