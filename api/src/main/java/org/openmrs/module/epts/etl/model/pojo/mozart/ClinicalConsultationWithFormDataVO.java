...
public class ClinicalConsultationWithFormDataVO extends AbstractDatabaseObject implements DatabaseObject { 
	private Integer id;
	...
	public ClinicalConsultationWithFormDataVO() { 
		this.metadata = false;
	} 
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO clinical_consultation_with_form_data(encounter_uuid, consultation_date, scheduled_date, form_id, encounter_type, patient_uuid, form_created_date, encounter_date, form_change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterUuid, this.consultationDate, this.scheduledDate, this.formId, this.encounterType, this.patientUuid, this.formCreatedDate, this.encounterDate, this.formChangeDate, this.locationUuid, this.sourceDatabase};		return params; 
	} 
 
	@JsonIgnore
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO clinical_consultation_with_form_data(id, encounter_uuid, consultation_date, scheduled_date, form_id, encounter_type, patient_uuid, form_created_date, encounter_date, form_change_date, location_uuid, source_database) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.encounterUuid, this.consultationDate, this.scheduledDate, this.formId, this.encounterType, this.patientUuid, this.formCreatedDate, this.encounterDate, this.formChangeDate, this.locationUuid, this.sourceDatabase};		return params; 
	} 
 
	@JsonIgnore
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterUuid, this.consultationDate, this.scheduledDate, this.formId, this.encounterType, this.patientUuid, this.formCreatedDate, this.encounterDate, this.formChangeDate, this.locationUuid, this.sourceDatabase, this.id};		return params; 
	} 
 
	@JsonIgnore
	public String getUpdateSQL(){ 
 		return "UPDATE clinical_consultation_with_form_data SET encounter_uuid = ?, consultation_date = ?, scheduled_date = ?, form_id = ?, encounter_type = ?, patient_uuid = ?, form_created_date = ?, encounter_date = ?, form_change_date = ?, location_uuid = ?, source_database = ? WHERE id = ?;"; 
	} 
