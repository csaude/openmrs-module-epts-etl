...
public class DsdVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO dsd(encounter_uuid, dsd_id, dsd_state_id, form_id, encounter_type, patient_uuid, created_date, change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	}
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.encounterUuid, this.dsdId, this.dsdStateId, this.formId, this.encounterType,
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.encounterUuid, this.dsdId, this.dsdStateId, this.dsdUuid, this.formId, this.encounterType,
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.encounterUuid, this.dsdId, this.dsdStateId, this.dsdUuid, this.formId, this.encounterType,
		        this.patientUuid, this.createdDate, this.encounterDate, this.changeDate, this.locationUuid,
		        this.sourceDatabase, this.dsdUuid, this.encounterDate };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE dsd SET encounter_uuid = ?, dsd_id = ?, dsd_state_id = ?, dsd_uuid = ?, form_id = ?, encounter_type = ?, patient_uuid = ?, created_date = ?, encounter_date = ?, change_date = ?, location_uuid = ?, source_database = ? WHERE dsd_uuid = ?  AND encounter_date = ? ";
	}
	...
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.encounterUuid != null ? "\"" + utilities.scapeQuotationMarks(encounterUuid) + "\"" : null) + ","
		        + (this.dsdId) + "," + (this.dsdStateId) + "," + (this.formId) + "," + (this.encounterType) + ","
	...
	public String generateInsertValuesWithObjectId() {
		return "" + (this.encounterUuid != null ? "\"" + utilities.scapeQuotationMarks(encounterUuid) + "\"" : null) + ","
		        ...
		        + (this.dsdUuid != null ? "\"" + utilities.scapeQuotationMarks(dsdUuid) + "\"" : null) + "," + (this.formId)
		        + "," + (this.encounterType) + ","
		        + (this.patientUuid != null ? "\"" + utilities.scapeQuotationMarks(patientUuid) + "\"" : null) + ","
		        + (this.createdDate != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(createdDate) + "\"" : null)
		        + ","
