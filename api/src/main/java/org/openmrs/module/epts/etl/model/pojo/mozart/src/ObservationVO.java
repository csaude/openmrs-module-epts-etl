...
public class ObservationVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.encounterUuid, this.conceptId, this.observationDate, this.valueNumeric, this.valueConceptId,
		        this.valueText, this.valueDatetime, this.obsUuid };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.id, this.encounterUuid, this.conceptId, this.observationDate, this.valueNumeric,
		        this.valueConceptId, this.valueText, this.valueDatetime, this.obsUuid };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.id, this.encounterUuid, this.conceptId, this.observationDate, this.valueNumeric,
		        this.valueConceptId, this.valueText, this.valueDatetime, this.obsUuid, this.id };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE observation SET id = ?, encounter_uuid = ?, concept_id = ?, observation_date = ?, value_numeric = ?, value_concept_id = ?, value_text = ?, value_datetime = ?, obs_uuid = ? WHERE id = ? ";
	}
