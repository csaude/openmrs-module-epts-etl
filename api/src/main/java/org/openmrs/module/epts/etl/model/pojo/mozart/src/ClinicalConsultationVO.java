...
public class ClinicalConsultationVO extends AbstractDatabaseObject implements DatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterUuid, this.consultationDate, this.scheduledDate, this.bpDiastolic, this.bpSystolic, this.whoStaging, this.weight, this.height, this.armCircumference, this.nutritionalGrade};		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.encounterUuid, this.consultationDate, this.scheduledDate, this.bpDiastolic, this.bpSystolic, this.whoStaging, this.weight, this.height, this.armCircumference, this.nutritionalGrade};		return params; 
	} 
 
	@JsonIgnore
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterUuid, this.consultationDate, this.scheduledDate, this.bpDiastolic, this.bpSystolic, this.whoStaging, this.weight, this.height, this.armCircumference, this.nutritionalGrade, this.id};		return params; 
	} 
 
	@JsonIgnore
	public String getUpdateSQL(){ 
 		return "UPDATE clinical_consultation SET encounter_uuid = ?, consultation_date = ?, scheduled_date = ?, bp_diastolic = ?, bp_systolic = ?, who_staging = ?, weight = ?, height = ?, arm_circumference = ?, nutritional_grade = ? WHERE id = ?;"; 
	} 
