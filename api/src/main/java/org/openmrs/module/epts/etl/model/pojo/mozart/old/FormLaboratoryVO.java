...
public class FormLaboratoryVO extends AbstractDatabaseObject implements DatabaseObject { 
	private Integer id;
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO form_laboratory(encounter_id, encounter_uuid, form_id, encounter_type, patient_uuid, created_date, encounter_date, change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
	...
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO form_laboratory(id, encounter_id, encounter_uuid, form_id, encounter_type, patient_uuid, created_date, encounter_date, change_date, location_uuid, source_database) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE form_laboratory SET encounter_id = ?, encounter_uuid = ?, form_id = ?, encounter_type = ?, patient_uuid = ?, created_date = ?, encounter_date = ?, change_date = ?, location_uuid = ?, source_database = ? WHERE id = ?;"; 
	} 
