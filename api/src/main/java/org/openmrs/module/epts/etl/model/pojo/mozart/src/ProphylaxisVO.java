...
public class ProphylaxisVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.encounterUuid, this.encounterDate, this.regimenProphylaxisTpt, this.regimenProphylaxisCtx,
		        ...
		        this.secondaryEffectsCtz, this.dispensationType, this.nextPickupDate };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.id, this.encounterUuid, this.encounterDate, this.regimenProphylaxisTpt,
		        this.regimenProphylaxisCtx, this.regimenProphylaxisPrep, this.noOfUnits, this.prophylaxisStatus,
		        this.secondaryEffectsTpt, this.secondaryEffectsCtz, this.dispensationType, this.nextPickupDate };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.id, this.encounterUuid, this.encounterDate, this.regimenProphylaxisTpt,
		        this.regimenProphylaxisCtx, this.regimenProphylaxisPrep, this.noOfUnits, this.prophylaxisStatus,
		        this.secondaryEffectsTpt, this.secondaryEffectsCtz, this.dispensationType, this.nextPickupDate, this.id };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE prophylaxis SET id = ?, encounter_uuid = ?, encounter_date = ?, regimen_prophylaxis_tpt = ?, regimen_prophylaxis_ctx = ?, regimen_prophylaxis_prep = ?, no_of_units = ?, prophylaxis_status = ?, secondary_effects_tpt = ?, secondary_effects_ctz = ?, dispensation_type = ?, next_pickup_date = ? WHERE id = ? ";
	}
