...
public class ObsVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public void load(ResultSet rs) throws SQLException {
		...
		if (rs.getObject("encounter_id") != null)
			this.encounterId = rs.getInt("encounter_id");
		if (rs.getObject("order_id") != null)
			this.orderId = rs.getInt("order_id");
		this.obsDatetime = rs.getTimestamp("obs_datetime") != null
		        ? new java.util.Date(rs.getTimestamp("obs_datetime").getTime())
		        : null;
		if (rs.getObject("location_id") != null)
			this.locationId = rs.getInt("location_id");
		if (rs.getObject("obs_group_id") != null)
			this.obsGroupId = rs.getInt("obs_group_id");
		this.accessionNumber = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("accession_number") != null ? rs.getString("accession_number").trim() : null);
		if (rs.getObject("value_group_id") != null)
			this.valueGroupId = rs.getInt("value_group_id");
		if (rs.getObject("value_coded") != null)
			this.valueCoded = rs.getInt("value_coded");
		if (rs.getObject("value_coded_name_id") != null)
			this.valueCodedNameId = rs.getInt("value_coded_name_id");
		if (rs.getObject("value_drug") != null)
			this.valueDrug = rs.getInt("value_drug");
		this.valueDatetime = rs.getTimestamp("value_datetime") != null
		        ? new java.util.Date(rs.getTimestamp("value_datetime").getTime())
		        : null;
		this.valueNumeric = rs.getDouble("value_numeric");
		this.valueModifier = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("value_modifier") != null ? rs.getString("value_modifier").trim() : null);
		this.valueText = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("value_text") != null ? rs.getString("value_text").trim() : null);
		this.comments = AttDefinedElements
		        .removeStrangeCharactersOnString(rs.getString("comments") != null ? rs.getString("comments").trim() : null);
		if (rs.getObject("creator") != null)
		...
		if (rs.getObject("voided_by") != null)
			this.voidedBy = rs.getInt("voided_by");
		this.dateVoided = rs.getTimestamp("date_voided") != null
		        ? new java.util.Date(rs.getTimestamp("date_voided").getTime())
		        : null;
		this.voidReason = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("void_reason") != null ? rs.getString("void_reason").trim() : null);
		this.valueComplex = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("value_complex") != null ? rs.getString("value_complex").trim() : null);
		this.uuid = AttDefinedElements
		        .removeStrangeCharactersOnString(rs.getString("uuid") != null ? rs.getString("uuid").trim() : null);
		if (rs.getObject("previous_version") != null)
			this.previousVersion = rs.getInt("previous_version");
		this.formNamespaceAndPath = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("form_namespace_and_path") != null ? rs.getString("form_namespace_and_path").trim() : null);
		this.status = AttDefinedElements
		        .removeStrangeCharactersOnString(rs.getString("status") != null ? rs.getString("status").trim() : null);
		this.interpretation = AttDefinedElements.removeStrangeCharactersOnString(
		    rs.getString("interpretation") != null ? rs.getString("interpretation").trim() : null);
	}
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.personId, this.conceptId, this.encounterId, this.orderId, this.obsDatetime, this.locationId,
		        this.obsGroupId, this.accessionNumber, this.valueGroupId, this.valueCoded, this.valueCodedNameId,
		        this.valueDrug, this.valueDatetime, this.valueNumeric, this.valueModifier, this.valueText, this.comments,
		        this.creator, this.dateCreated, this.voided, this.voidedBy, this.dateVoided, this.voidReason,
		        this.valueComplex, this.uuid, this.previousVersion, this.formNamespaceAndPath, this.status,
		        this.interpretation };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.obsId, this.personId, this.conceptId, this.encounterId, this.orderId, this.obsDatetime,
		        this.locationId, this.obsGroupId, this.accessionNumber, this.valueGroupId, this.valueCoded,
		        this.valueCodedNameId, this.valueDrug, this.valueDatetime, this.valueNumeric, this.valueModifier,
		        this.valueText, this.comments, this.creator, this.dateCreated, this.voided, this.voidedBy, this.dateVoided,
		        this.voidReason, this.valueComplex, this.uuid, this.previousVersion, this.formNamespaceAndPath, this.status,
		        this.interpretation };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.personId, this.conceptId, this.encounterId, this.orderId, this.obsDatetime, this.locationId,
		        ...
		        this.creator, this.dateCreated, this.voided, this.voidedBy, this.dateVoided, this.voidReason,
		        this.valueComplex, this.uuid, this.previousVersion, this.formNamespaceAndPath, this.status,
		        this.interpretation, this.obsId };
		return params;
	}
	...
	public String generateInsertValues() {
		return "" + (this.personId) + "," + (this.conceptId) + "," + (this.encounterId) + "," + (this.orderId) + ","
		        + (this.obsDatetime != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(obsDatetime) + "\"" : null)
		        + "," + (this.locationId) + "," + (this.obsGroupId) + ","
		        + (this.accessionNumber != null ? "\"" + utilities.scapeQuotationMarks(accessionNumber) + "\"" : null) + ","
		        + (this.valueGroupId) + "," + (this.valueCoded) + "," + (this.valueCodedNameId) + "," + (this.valueDrug)
		        + ","
		        + (this.valueDatetime != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(valueDatetime) + "\""
		                : null)
		        + "," + (this.valueNumeric) + ","
		        + (this.valueModifier != null ? "\"" + utilities.scapeQuotationMarks(valueModifier) + "\"" : null) + ","
		        + (this.valueText != null ? "\"" + utilities.scapeQuotationMarks(valueText) + "\"" : null) + ","
		        + (this.comments != null ? "\"" + utilities.scapeQuotationMarks(comments) + "\"" : null) + ","
		        + (this.creator) + ","
		        + (this.dateCreated != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated) + "\"" : null)
		        + "," + (this.voided) + "," + (this.voidedBy) + ","
		        + (this.dateVoided != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateVoided) + "\"" : null)
		        + "," + (this.voidReason != null ? "\"" + utilities.scapeQuotationMarks(voidReason) + "\"" : null) + ","
		        + (this.valueComplex != null ? "\"" + utilities.scapeQuotationMarks(valueComplex) + "\"" : null) + ","
		        + (this.uuid != null ? "\"" + utilities.scapeQuotationMarks(uuid) + "\"" : null) + ","
		        + (this.previousVersion) + ","
		        + (this.formNamespaceAndPath != null ? "\"" + utilities.scapeQuotationMarks(formNamespaceAndPath) + "\""
		                : null)
		        + "," + (this.status != null ? "\"" + utilities.scapeQuotationMarks(status) + "\"" : null) + ","
		        + (this.interpretation != null ? "\"" + utilities.scapeQuotationMarks(interpretation) + "\"" : null);
	}
	
	@Override
	public boolean hasParents() {
		if (this.valueCoded != 0)
			return true;
		...
		if (this.obsGroupId != 0)
			return true;
		
		if (this.locationId != 0)
			return true;
		
		if (this.valueCodedNameId != 0)
			return true;
