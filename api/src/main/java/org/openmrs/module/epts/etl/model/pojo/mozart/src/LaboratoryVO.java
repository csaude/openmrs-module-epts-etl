...
public class LaboratoryVO extends AbstractDatabaseObject implements DatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterUuid, this.encounterDate, this.labTestId, this.request, this.orderDate, this.sampleCollectionDate, this.resultReportDate, this.resultQualitativeId, this.resultNumeric, this.resultUnits, this.resultComment, this.specimenTypeId, this.labtestUuid};		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.encounterUuid, this.encounterDate, this.labTestId, this.request, this.orderDate, this.sampleCollectionDate, this.resultReportDate, this.resultQualitativeId, this.resultNumeric, this.resultUnits, this.resultComment, this.specimenTypeId, this.labtestUuid};		return params; 
	} 
 
	@JsonIgnore
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterUuid, this.encounterDate, this.labTestId, this.request, this.orderDate, this.sampleCollectionDate, this.resultReportDate, this.resultQualitativeId, this.resultNumeric, this.resultUnits, this.resultComment, this.specimenTypeId, this.labtestUuid, this.id};		return params; 
	} 
 
	@JsonIgnore
	public String getUpdateSQL(){ 
 		return "UPDATE laboratory SET encounter_uuid = ?, encounter_date = ?, lab_test_id = ?, request = ?, order_date = ?, sample_collection_date = ?, result_report_date = ?, result_qualitative_id = ?, result_numeric = ?, result_units = ?, result_comment = ?, specimen_type_id = ?, labtest_uuid = ? WHERE id = ?;"; 
	} 
