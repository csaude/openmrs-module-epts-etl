...
this.source = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("source") != null ? rs.getString("source").trim() : null);
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.patientId, this.encounterId, this.programId, this.encounterUuid, this.programUuid, this.dateStatus, this.cacumWomenStatus, this.source};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.patientId, this.encounterId, this.programId, this.encounterUuid, this.programUuid, this.dateStatus, this.cacumWomenStatus, this.source};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.id, this.patientId, this.encounterId, this.programId, this.encounterUuid, this.programUuid, this.dateStatus, this.cacumWomenStatus, this.source, this.id};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE cacum_women_pregnant_lactation SET id = ?, patient_id = ?, encounter_id = ?, program_id = ?, encounter_uuid = ?, program_uuid = ?, date_status = ?, cacum_women_status = ?, source = ? WHERE id = ? "; 
	} 
	...
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.id) + "," + (this.patientId) + "," + (this.encounterId) + "," + (this.programId) + "," + (this.encounterUuid != null ? "\""+ utilities.scapeQuotationMarks(encounterUuid)  +"\"" : null) + "," + (this.programUuid != null ? "\""+ utilities.scapeQuotationMarks(programUuid)  +"\"" : null) + "," + (this.dateStatus != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateStatus)  +"\"" : null) + "," + (this.cacumWomenStatus != null ? "\""+ utilities.scapeQuotationMarks(cacumWomenStatus)  +"\"" : null) + "," + (this.source != null ? "\""+ utilities.scapeQuotationMarks(source)  +"\"" : null); 
	} 
