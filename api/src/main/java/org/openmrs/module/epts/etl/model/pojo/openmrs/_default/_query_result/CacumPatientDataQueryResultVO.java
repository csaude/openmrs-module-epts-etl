...
public class CacumPatientDataQueryResultVO extends AbstractDatabaseObject implements DatabaseObject { 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.patientId, this.patientUuid, this.ageEnrollment, this.currentAge, this.sex, this.birthdate, this.urban, this.main, this.enrollmentDate, this.locationId, this.healthFacility, this.district, this.educationAtEnrollment, this.occupationAtEnrollment, this.maritalStatusAtEnrollment, this.adress1, this.adress2, this.village, this.artInitiationDate, this.pregnancyStatusAtEnrollment, null};		return params; 
	} 
 
	@JsonIgnore
	public String getUpdateSQL(){ 
 		return "UPDATE cacum_patient_data SET patient_id = ?, patient_uuid = ?, age_enrollment = ?, current_age = ?, sex = ?, birthdate = ?, urban = ?, main = ?, enrollment_date = ?, location_id = ?, health_facility = ?, district = ?, education_at_enrollment = ?, occupation_at_enrollment = ?, marital_status_at_enrollment = ?, adress_1 = ?, adress_2 = ?, village = ?, art_initiation_date = ?, pregnancy_status_at_enrollment = ? WHERE null = ?;"; 
	} 
