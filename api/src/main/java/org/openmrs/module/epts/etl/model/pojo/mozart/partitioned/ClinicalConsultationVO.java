...
public class ClinicalConsultationVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO clinical_consultation(scheduled_date, bp_diastolic, bp_systolic, who_staging, weight, height, arm_circumference, nutritional_grade, form_id, encounter_type, patient_uuid, created_date, encounter_date, change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	}
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.scheduledDate, this.bpDiastolic, this.bpSystolic, this.whoStaging, this.weight, this.height,
		        this.armCircumference, this.nutritionalGrade, this.formId, this.encounterType, this.patientUuid,
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.encounterUuid, this.consultationDate, this.scheduledDate, this.bpDiastolic, this.bpSystolic,
		        this.whoStaging, this.weight, this.height, this.armCircumference, this.nutritionalGrade, this.formId,
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.encounterUuid, this.consultationDate, this.scheduledDate, this.bpDiastolic, this.bpSystolic,
		        this.whoStaging, this.weight, this.height, this.armCircumference, this.nutritionalGrade, this.formId,
		        this.encounterType, this.patientUuid, this.createdDate, this.encounterDate, this.changeDate,
		        this.locationUuid, this.sourceDatabase, this.consultationDate, this.encounterUuid };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE clinical_consultation SET encounter_uuid = ?, consultation_date = ?, scheduled_date = ?, bp_diastolic = ?, bp_systolic = ?, who_staging = ?, weight = ?, height = ?, arm_circumference = ?, nutritional_grade = ?, form_id = ?, encounter_type = ?, patient_uuid = ?, created_date = ?, encounter_date = ?, change_date = ?, location_uuid = ?, source_database = ? WHERE consultation_date = ?  AND encounter_uuid = ? ";
	}
	...
	public String generateInsertValuesWithoutObjectId() {
		return ""
		        ...
		        + (this.height) + "," + (this.armCircumference) + "," + (this.nutritionalGrade) + "," + (this.formId) + ","
		        + (this.encounterType) + ","
