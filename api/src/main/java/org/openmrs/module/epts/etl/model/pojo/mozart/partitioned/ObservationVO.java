...
public class ObservationVO extends AbstractDatabaseObject implements DatabaseObject {
	...
	public void load(ResultSet rs) throws SQLException {
		...
		this.observationDate = rs.getTimestamp("observation_date") != null
		        ? new java.util.Date(rs.getTimestamp("observation_date").getTime())
		        : null;
		if (rs.getObject("value_numeric") != null)
			this.valueNumeric = rs.getDouble("value_numeric");
		if (rs.getObject("value_concept_id") != null)
			this.valueConceptId = rs.getInt("value_concept_id");
		...
		this.valueDatetime = rs.getTimestamp("value_datetime") != null
		        ...
		        : null;
		this.obsUuid = AttDefinedElements
		        .removeStrangeCharactersOnString(rs.getString("obs_uuid") != null ? rs.getString("obs_uuid").trim() : null);
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO observation(encounter_uuid, concept_id, value_numeric, value_concept_id, value_text, value_datetime, form_id, encounter_type, patient_uuid, created_date, encounter_date, change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	}
	
	@JsonIgnore
	@Override
	public String getInsertSQLWithObjectId() {
		return "INSERT INTO observation(encounter_uuid, concept_id, observation_date, value_numeric, value_concept_id, value_text, value_datetime, obs_uuid, form_id, encounter_type, patient_uuid, created_date, encounter_date, change_date, location_uuid, source_database) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	}
	
	@JsonIgnore
	@Override
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.encounterUuid, this.conceptId, this.valueNumeric, this.valueConceptId, this.valueText,
		        this.valueDatetime, this.formId, this.encounterType, this.patientUuid, this.createdDate, this.encounterDate,
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.encounterUuid, this.conceptId, this.observationDate, this.valueNumeric, this.valueConceptId,
		        this.valueText, this.valueDatetime, this.obsUuid, this.formId, this.encounterType, this.patientUuid,
		        this.createdDate, this.encounterDate, this.changeDate, this.locationUuid, this.sourceDatabase };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.encounterUuid, this.conceptId, this.observationDate, this.valueNumeric, this.valueConceptId,
		        this.valueText, this.valueDatetime, this.obsUuid, this.formId, this.encounterType, this.patientUuid,
		        this.createdDate, this.encounterDate, this.changeDate, this.locationUuid, this.sourceDatabase, this.obsUuid,
	...
	public String getUpdateSQL() {
		return "UPDATE observation SET encounter_uuid = ?, concept_id = ?, observation_date = ?, value_numeric = ?, value_concept_id = ?, value_text = ?, value_datetime = ?, obs_uuid = ?, form_id = ?, encounter_type = ?, patient_uuid = ?, created_date = ?, encounter_date = ?, change_date = ?, location_uuid = ?, source_database = ? WHERE obs_uuid = ?  AND observation_date = ? ";
	}
	...
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.encounterUuid != null ? "\"" + utilities.scapeQuotationMarks(encounterUuid) + "\"" : null) + ","
		        + (this.conceptId) + "," + (this.valueNumeric) + "," + (this.valueConceptId) + ","
	...
	public String generateInsertValuesWithObjectId() {
		return "" + (this.encounterUuid != null ? "\"" + utilities.scapeQuotationMarks(encounterUuid) + "\"" : null) + ","
		        + (this.conceptId) + ","
		        + (this.observationDate != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(observationDate) + "\""
		                : null)
		        + "," + (this.valueNumeric) + "," + (this.valueConceptId) + ","
		        + (this.valueText != null ? "\"" + utilities.scapeQuotationMarks(valueText) + "\"" : null) + ","
		        + (this.valueDatetime != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(valueDatetime) + "\""
		                : null)
		        + "," + (this.obsUuid != null ? "\"" + utilities.scapeQuotationMarks(obsUuid) + "\"" : null) + ","
		        + (this.formId) + "," + (this.encounterType) + ","
		        + (this.patientUuid != null ? "\"" + utilities.scapeQuotationMarks(patientUuid) + "\"" : null) + ","
		        + (this.createdDate != null ? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(createdDate) + "\"" : null)
		        + ","
