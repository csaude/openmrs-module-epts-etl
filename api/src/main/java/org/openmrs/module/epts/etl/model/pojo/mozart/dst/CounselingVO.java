...
public class CounselingVO extends AbstractDatabaseObject implements DatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		if (rs.getObject("diagnosis_reveal") != null) this.diagnosisReveal = rs.getInt("diagnosis_reveal");
		if (rs.getObject("hiv_disclosure") != null) this.hivDisclosure = rs.getInt("hiv_disclosure");
		if (rs.getObject("adherence_plan") != null) this.adherencePlan = rs.getInt("adherence_plan");
		if (rs.getObject("secondary_effects") != null) this.secondaryEffects = rs.getInt("secondary_effects");
		if (rs.getObject("adherence_art") != null) this.adherenceArt = rs.getInt("adherence_art");
		if (rs.getObject("adherence_percent") != null) this.adherencePercent = rs.getDouble("adherence_percent");
		if (rs.getObject("consultation_reason") != null) this.consultationReason = rs.getInt("consultation_reason");
		if (rs.getObject("accept_contact") != null) this.acceptContact = rs.getInt("accept_contact");
		this.acceptDate =  rs.getTimestamp("accept_date") != null ? new java.util.Date( rs.getTimestamp("accept_date").getTime() ) : null;
		if (rs.getObject("psychosocial_refusal") != null) this.psychosocialRefusal = rs.getInt("psychosocial_refusal");
		if (rs.getObject("psychosocial_sick") != null) this.psychosocialSick = rs.getInt("psychosocial_sick");
		if (rs.getObject("psychosocial_notbelieve") != null) this.psychosocialNotbelieve = rs.getInt("psychosocial_notbelieve");
		if (rs.getObject("psychosocial_lotofpills") != null) this.psychosocialLotofpills = rs.getInt("psychosocial_lotofpills");
		if (rs.getObject("psychosocial_feelbetter") != null) this.psychosocialFeelbetter = rs.getInt("psychosocial_feelbetter");
		if (rs.getObject("psychosocial_lackfood") != null) this.psychosocialLackfood = rs.getInt("psychosocial_lackfood");
		if (rs.getObject("psychosocial_lacksupport") != null) this.psychosocialLacksupport = rs.getInt("psychosocial_lacksupport");
		if (rs.getObject("psychosocial_depression") != null) this.psychosocialDepression = rs.getInt("psychosocial_depression");
		if (rs.getObject("psychosocial_notreveal") != null) this.psychosocialNotreveal = rs.getInt("psychosocial_notreveal");
		if (rs.getObject("psychosocial_toxicity") != null) this.psychosocialToxicity = rs.getInt("psychosocial_toxicity");
		if (rs.getObject("psychosocial_lostpills") != null) this.psychosocialLostpills = rs.getInt("psychosocial_lostpills");
		if (rs.getObject("psychosocial_stigma") != null) this.psychosocialStigma = rs.getInt("psychosocial_stigma");
		if (rs.getObject("psychosocial_transport") != null) this.psychosocialTransport = rs.getInt("psychosocial_transport");
		if (rs.getObject("psychosocial_gbv") != null) this.psychosocialGbv = rs.getInt("psychosocial_gbv");
		if (rs.getObject("psychosocial_cultural") != null) this.psychosocialCultural = rs.getInt("psychosocial_cultural");
		if (rs.getObject("psychosocial_druguse") != null) this.psychosocialDruguse = rs.getInt("psychosocial_druguse");
		if (rs.getObject("pp1") != null) this.pp1 = rs.getInt("pp1");
		if (rs.getObject("pp2") != null) this.pp2 = rs.getInt("pp2");
		if (rs.getObject("pp3") != null) this.pp3 = rs.getInt("pp3");
		if (rs.getObject("pp4") != null) this.pp4 = rs.getInt("pp4");
		if (rs.getObject("pp5") != null) this.pp5 = rs.getInt("pp5");
		if (rs.getObject("pp6") != null) this.pp6 = rs.getInt("pp6");
		if (rs.getObject("pp7") != null) this.pp7 = rs.getInt("pp7");
		if (rs.getObject("keypop_lubricants") != null) this.keypopLubricants = rs.getInt("keypop_lubricants");
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterUuid, this.encounterDate, this.diagnosisReveal, this.hivDisclosure, this.adherencePlan, this.secondaryEffects, this.adherenceArt, this.adherencePercent, this.consultationReason, this.acceptContact, this.acceptDate, this.psychosocialRefusal, this.psychosocialSick, this.psychosocialNotbelieve, this.psychosocialLotofpills, this.psychosocialFeelbetter, this.psychosocialLackfood, this.psychosocialLacksupport, this.psychosocialDepression, this.psychosocialNotreveal, this.psychosocialToxicity, this.psychosocialLostpills, this.psychosocialStigma, this.psychosocialTransport, this.psychosocialGbv, this.psychosocialCultural, this.psychosocialDruguse, this.pp1, this.pp2, this.pp3, this.pp4, this.pp5, this.pp6, this.pp7, this.keypopLubricants, this.formId, this.encounterType, this.patientUuid, this.createdDate, this.changeDate, this.locationUuid, this.sourceDatabase};		return params; 
	} 
 
	@JsonIgnore
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO counseling(id, encounter_uuid, encounter_date, diagnosis_reveal, hiv_disclosure, adherence_plan, secondary_effects, adherence_art, adherence_percent, consultation_reason, accept_contact, accept_date, psychosocial_refusal, psychosocial_sick, psychosocial_notbelieve, psychosocial_lotofpills, psychosocial_feelbetter, psychosocial_lackfood, psychosocial_lacksupport, psychosocial_depression, psychosocial_notreveal, psychosocial_toxicity, psychosocial_lostpills, psychosocial_stigma, psychosocial_transport, psychosocial_gbv, psychosocial_cultural, psychosocial_druguse, pp1, pp2, pp3, pp4, pp5, pp6, pp7, keypop_lubricants, form_id, encounter_type, patient_uuid, created_date, change_date, location_uuid, source_database) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.encounterUuid, this.encounterDate, this.diagnosisReveal, this.hivDisclosure, this.adherencePlan, this.secondaryEffects, this.adherenceArt, this.adherencePercent, this.consultationReason, this.acceptContact, this.acceptDate, this.psychosocialRefusal, this.psychosocialSick, this.psychosocialNotbelieve, this.psychosocialLotofpills, this.psychosocialFeelbetter, this.psychosocialLackfood, this.psychosocialLacksupport, this.psychosocialDepression, this.psychosocialNotreveal, this.psychosocialToxicity, this.psychosocialLostpills, this.psychosocialStigma, this.psychosocialTransport, this.psychosocialGbv, this.psychosocialCultural, this.psychosocialDruguse, this.pp1, this.pp2, this.pp3, this.pp4, this.pp5, this.pp6, this.pp7, this.keypopLubricants, this.formId, this.encounterType, this.patientUuid, this.createdDate, this.changeDate, this.locationUuid, this.sourceDatabase};		return params; 
	} 
