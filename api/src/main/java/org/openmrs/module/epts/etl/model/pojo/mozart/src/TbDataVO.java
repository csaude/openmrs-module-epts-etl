...
public class TbDataVO extends AbstractDatabaseObject implements DatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		if (rs.getObject("tb_symptom") != null) this.tbSymptom = rs.getInt("tb_symptom");
		if (rs.getObject("symptom_fever") != null) this.symptomFever = rs.getInt("symptom_fever");
		if (rs.getObject("symptom_weight_loss") != null) this.symptomWeightLoss = rs.getInt("symptom_weight_loss");
		if (rs.getObject("symptom_night_sweat") != null) this.symptomNightSweat = rs.getInt("symptom_night_sweat");
		if (rs.getObject("symptom_cough") != null) this.symptomCough = rs.getInt("symptom_cough");
		if (rs.getObject("symptom_asthenia") != null) this.symptomAsthenia = rs.getInt("symptom_asthenia");
		if (rs.getObject("symptom_tb_contact") != null) this.symptomTbContact = rs.getInt("symptom_tb_contact");
		if (rs.getObject("symptom_adenopathy") != null) this.symptomAdenopathy = rs.getInt("symptom_adenopathy");
		if (rs.getObject("tb_diagnose") != null) this.tbDiagnose = rs.getInt("tb_diagnose");
		if (rs.getObject("tb_treatment") != null) this.tbTreatment = rs.getInt("tb_treatment");
		this.tbTreatmentDate =  rs.getTimestamp("tb_treatment_date") != null ? new java.util.Date( rs.getTimestamp("tb_treatment_date").getTime() ) : null;
	} 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterUuid, this.encounterDate, this.tbSymptom, this.symptomFever, this.symptomWeightLoss, this.symptomNightSweat, this.symptomCough, this.symptomAsthenia, this.symptomTbContact, this.symptomAdenopathy, this.tbDiagnose, this.tbTreatment, this.tbTreatmentDate};		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.encounterUuid, this.encounterDate, this.tbSymptom, this.symptomFever, this.symptomWeightLoss, this.symptomNightSweat, this.symptomCough, this.symptomAsthenia, this.symptomTbContact, this.symptomAdenopathy, this.tbDiagnose, this.tbTreatment, this.tbTreatmentDate};		return params; 
	} 
 
	@JsonIgnore
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterUuid, this.encounterDate, this.tbSymptom, this.symptomFever, this.symptomWeightLoss, this.symptomNightSweat, this.symptomCough, this.symptomAsthenia, this.symptomTbContact, this.symptomAdenopathy, this.tbDiagnose, this.tbTreatment, this.tbTreatmentDate, this.id};		return params; 
	} 
 
	@JsonIgnore
	public String getUpdateSQL(){ 
 		return "UPDATE tb_data SET encounter_uuid = ?, encounter_date = ?, tb_symptom = ?, symptom_fever = ?, symptom_weight_loss = ?, symptom_night_sweat = ?, symptom_cough = ?, symptom_asthenia = ?, symptom_tb_contact = ?, symptom_adenopathy = ?, tb_diagnose = ?, tb_treatment = ?, tb_treatment_date = ? WHERE id = ?;"; 
	} 
 
	@JsonIgnore
	public String generateInsertValues(){ 
 		return ""+(this.encounterUuid != null ? "\""+ utilities.scapeQuotationMarks(encounterUuid)  +"\"" : null) + "," + (this.encounterDate != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(encounterDate)  +"\"" : null) + "," + (this.tbSymptom) + "," + (this.symptomFever) + "," + (this.symptomWeightLoss) + "," + (this.symptomNightSweat) + "," + (this.symptomCough) + "," + (this.symptomAsthenia) + "," + (this.symptomTbContact) + "," + (this.symptomAdenopathy) + "," + (this.tbDiagnose) + "," + (this.tbTreatment) + "," + (this.tbTreatmentDate != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(tbTreatmentDate)  +"\"" : null); 
	} 
