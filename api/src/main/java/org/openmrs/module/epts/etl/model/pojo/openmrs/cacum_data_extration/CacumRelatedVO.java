...
public class CacumRelatedVO extends AbstractDatabaseObject implements DatabaseObject { 
	private Integer id;
	...
	private Integer ageFirstSexual;
	...
	public void setAgeFirstSexual(Integer ageFirstSexual){ 
	 	this.ageFirstSexual = ageFirstSexual;
	}
 
	public Integer getAgeFirstSexual(){ 
...
if (rs.getObject("age_first_sexual") != null) this.ageFirstSexual = rs.getInt("age_first_sexual");
...
this.source = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("source") != null ? rs.getString("source").trim() : null);
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO cacum_related(encounter_id, patient_id, encounter_uuid, hiv, visit_date, age_first_sexual, via_result, cryotherapy_same_day_via, reference_hospital_name, reason_referral_1, reason_referral_2, reason_referral_3, reason_referral_4, reason_referral_5, hdr, reference_result_hdr1, reference_result_hdr2, reference_result_hdr3, reference_result_hdr4, reference_result_hdr5, reference_result_hdr6, source) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO cacum_related(id, encounter_id, patient_id, encounter_uuid, hiv, visit_date, age_first_sexual, via_result, cryotherapy_same_day_via, reference_hospital_name, reason_referral_1, reason_referral_2, reason_referral_3, reason_referral_4, reason_referral_5, hdr, reference_result_hdr1, reference_result_hdr2, reference_result_hdr3, reference_result_hdr4, reference_result_hdr5, reference_result_hdr6, source) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterId, this.patientId, this.encounterUuid, this.hiv, this.visitDate, this.ageFirstSexual, this.viaResult, this.cryotherapySameDayVia, this.referenceHospitalName, this.reasonReferral1, this.reasonReferral2, this.reasonReferral3, this.reasonReferral4, this.reasonReferral5, this.hdr, this.referenceResultHdr1, this.referenceResultHdr2, this.referenceResultHdr3, this.referenceResultHdr4, this.referenceResultHdr5, this.referenceResultHdr6, this.source};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.id, this.encounterId, this.patientId, this.encounterUuid, this.hiv, this.visitDate, this.ageFirstSexual, this.viaResult, this.cryotherapySameDayVia, this.referenceHospitalName, this.reasonReferral1, this.reasonReferral2, this.reasonReferral3, this.reasonReferral4, this.reasonReferral5, this.hdr, this.referenceResultHdr1, this.referenceResultHdr2, this.referenceResultHdr3, this.referenceResultHdr4, this.referenceResultHdr5, this.referenceResultHdr6, this.source};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.id, this.encounterId, this.patientId, this.encounterUuid, this.hiv, this.visitDate, this.ageFirstSexual, this.viaResult, this.cryotherapySameDayVia, this.referenceHospitalName, this.reasonReferral1, this.reasonReferral2, this.reasonReferral3, this.reasonReferral4, this.reasonReferral5, this.hdr, this.referenceResultHdr1, this.referenceResultHdr2, this.referenceResultHdr3, this.referenceResultHdr4, this.referenceResultHdr5, this.referenceResultHdr6, this.source, this.id};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE cacum_related SET id = ?, encounter_id = ?, patient_id = ?, encounter_uuid = ?, hiv = ?, visit_date = ?, age_first_sexual = ?, via_result = ?, cryotherapy_same_day_via = ?, reference_hospital_name = ?, reason_referral_1 = ?, reason_referral_2 = ?, reason_referral_3 = ?, reason_referral_4 = ?, reason_referral_5 = ?, hdr = ?, reference_result_hdr1 = ?, reference_result_hdr2 = ?, reference_result_hdr3 = ?, reference_result_hdr4 = ?, reference_result_hdr5 = ?, reference_result_hdr6 = ?, source = ? WHERE id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.encounterId) + "," + (this.patientId) + "," + (this.encounterUuid != null ? "\""+ utilities.scapeQuotationMarks(encounterUuid)  +"\"" : null) + "," + (this.hiv != null ? "\""+ utilities.scapeQuotationMarks(hiv)  +"\"" : null) + "," + (this.visitDate != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(visitDate)  +"\"" : null) + "," + (this.ageFirstSexual) + "," + (this.viaResult != null ? "\""+ utilities.scapeQuotationMarks(viaResult)  +"\"" : null) + "," + (this.cryotherapySameDayVia != null ? "\""+ utilities.scapeQuotationMarks(cryotherapySameDayVia)  +"\"" : null) + "," + (this.referenceHospitalName != null ? "\""+ utilities.scapeQuotationMarks(referenceHospitalName)  +"\"" : null) + "," + (this.reasonReferral1 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral1)  +"\"" : null) + "," + (this.reasonReferral2 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral2)  +"\"" : null) + "," + (this.reasonReferral3 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral3)  +"\"" : null) + "," + (this.reasonReferral4 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral4)  +"\"" : null) + "," + (this.reasonReferral5 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral5)  +"\"" : null) + "," + (this.hdr != null ? "\""+ utilities.scapeQuotationMarks(hdr)  +"\"" : null) + "," + (this.referenceResultHdr1 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr1)  +"\"" : null) + "," + (this.referenceResultHdr2 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr2)  +"\"" : null) + "," + (this.referenceResultHdr3 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr3)  +"\"" : null) + "," + (this.referenceResultHdr4 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr4)  +"\"" : null) + "," + (this.referenceResultHdr5 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr5)  +"\"" : null) + "," + (this.referenceResultHdr6 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr6)  +"\"" : null) + "," + (this.source != null ? "\""+ utilities.scapeQuotationMarks(source)  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.id) + "," + (this.encounterId) + "," + (this.patientId) + "," + (this.encounterUuid != null ? "\""+ utilities.scapeQuotationMarks(encounterUuid)  +"\"" : null) + "," + (this.hiv != null ? "\""+ utilities.scapeQuotationMarks(hiv)  +"\"" : null) + "," + (this.visitDate != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(visitDate)  +"\"" : null) + "," + (this.ageFirstSexual) + "," + (this.viaResult != null ? "\""+ utilities.scapeQuotationMarks(viaResult)  +"\"" : null) + "," + (this.cryotherapySameDayVia != null ? "\""+ utilities.scapeQuotationMarks(cryotherapySameDayVia)  +"\"" : null) + "," + (this.referenceHospitalName != null ? "\""+ utilities.scapeQuotationMarks(referenceHospitalName)  +"\"" : null) + "," + (this.reasonReferral1 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral1)  +"\"" : null) + "," + (this.reasonReferral2 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral2)  +"\"" : null) + "," + (this.reasonReferral3 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral3)  +"\"" : null) + "," + (this.reasonReferral4 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral4)  +"\"" : null) + "," + (this.reasonReferral5 != null ? "\""+ utilities.scapeQuotationMarks(reasonReferral5)  +"\"" : null) + "," + (this.hdr != null ? "\""+ utilities.scapeQuotationMarks(hdr)  +"\"" : null) + "," + (this.referenceResultHdr1 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr1)  +"\"" : null) + "," + (this.referenceResultHdr2 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr2)  +"\"" : null) + "," + (this.referenceResultHdr3 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr3)  +"\"" : null) + "," + (this.referenceResultHdr4 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr4)  +"\"" : null) + "," + (this.referenceResultHdr5 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr5)  +"\"" : null) + "," + (this.referenceResultHdr6 != null ? "\""+ utilities.scapeQuotationMarks(referenceResultHdr6)  +"\"" : null) + "," + (this.source != null ? "\""+ utilities.scapeQuotationMarks(source)  +"\"" : null); 
	} 
