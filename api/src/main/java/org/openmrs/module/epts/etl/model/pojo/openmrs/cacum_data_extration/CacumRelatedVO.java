...
public class CacumRelatedVO extends AbstractDatabaseObject implements DatabaseObject { 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterId, this.patientId, this.encounterUuid, this.hiv, this.visitDate, this.ageFirstSexual, this.viaResult, this.cryotherapySameDayVia, this.referenceHospitalName, this.reasonReferral1, this.reasonReferral2, this.reasonReferral3, this.reasonReferral4, this.reasonReferral5, this.hdr, this.referenceResultHdr1, this.referenceResultHdr2, this.referenceResultHdr3, this.referenceResultHdr4, this.referenceResultHdr5, this.referenceResultHdr6, this.source, this.id};		return params; 
	} 
 
	@JsonIgnore
	public String getUpdateSQL(){ 
 		return "UPDATE cacum_related SET encounter_id = ?, patient_id = ?, encounter_uuid = ?, hiv = ?, visit_date = ?, age_first_sexual = ?, via_result = ?, cryotherapy_same_day_via = ?, reference_hospital_name = ?, reason_referral_1 = ?, reason_referral_2 = ?, reason_referral_3 = ?, reason_referral_4 = ?, reason_referral_5 = ?, hdr = ?, reference_result_hdr1 = ?, reference_result_hdr2 = ?, reference_result_hdr3 = ?, reference_result_hdr4 = ?, reference_result_hdr5 = ?, reference_result_hdr6 = ?, source = ? WHERE id = ?;"; 
	} 
