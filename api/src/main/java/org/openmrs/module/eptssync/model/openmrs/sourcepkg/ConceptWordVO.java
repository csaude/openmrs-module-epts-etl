...
public class ConceptWordVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.word = rs.getString("word") != null ? rs.getString("word").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.conceptId == 0 ? null : this.conceptId) + "," + (this.word != null ? "\""+word+"\"" : null) + "," + (this.locale != null ? "\""+locale+"\"" : null) + "," + (this.conceptNameId == 0 ? null : this.conceptNameId) + "," + (this.weight); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptNameVO.class, this.conceptNameId, false, conn); 
