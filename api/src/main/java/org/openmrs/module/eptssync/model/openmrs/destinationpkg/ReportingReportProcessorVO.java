...
public class ReportingReportProcessorVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.processorType = rs.getString("processor_type") != null ? rs.getString("processor_type").trim() : null;
		this.configuration = rs.getString("configuration") != null ? rs.getString("configuration").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.uuid != null ? "\""+uuid+"\"" : null) + "," + (this.name != null ? "\""+name+"\"" : null) + "," + (this.description != null ? "\""+description+"\"" : null) + "," + (this.processorType != null ? "\""+processorType+"\"" : null) + "," + (this.configuration != null ? "\""+configuration+"\"" : null) + "," + (this.runOnSuccess) + "," + (this.runOnError) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.retired) + "," + (this.retiredBy == 0 ? null : this.retiredBy) + "," + (this.dateRetired != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateRetired)  +"\"" : null) + "," + (this.retireReason != null ? "\""+retireReason+"\"" : null) + "," + (this.reportDesignId == 0 ? null : this.reportDesignId) + "," + (this.processorMode != null ? "\""+processorMode+"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ReportingReportDesignVO.class, this.reportDesignId, true, conn); 
