...
public class ConceptNumericVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.units = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("units") != null ? rs.getString("units").trim() : null);
		this.precise = rs.getByte("precise");
		this.displayPrecision = rs.getInt("display_precision");
	} 
	...
	public String generateInsertValues(){ 
 		return ""+(this.hiAbsolute) + "," + (this.hiCritical) + "," + (this.hiNormal) + "," + (this.lowAbsolute) + "," + (this.lowCritical) + "," + (this.lowNormal) + "," + (this.units != null ? "\""+ utilities.scapeQuotationMarks(units)  +"\"" : null) + "," + (this.precise) + "," + (this.displayPrecision); 
	} 
