...
public class ConditionsVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.conditionNonCoded = rs.getString("condition_non_coded") != null ? rs.getString("condition_non_coded").trim() : null;
		this.onsetDate =  rs.getTimestamp("onset_date") != null ? new java.util.Date( rs.getTimestamp("onset_date").getTime() ) : null;
		this.additionalDetail = rs.getString("additional_detail") != null ? rs.getString("additional_detail").trim() : null;
