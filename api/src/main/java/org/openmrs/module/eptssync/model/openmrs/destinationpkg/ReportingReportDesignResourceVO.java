...
public class ReportingReportDesignResourceVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.contentType = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("content_type") != null ? rs.getString("content_type").trim() : null);
		this.extension = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("extension") != null ? rs.getString("extension").trim() : null);
	...
	public String generateInsertValues(){ 
 		return ""+(this.uuid != null ? "\""+ utilities.scapeQuotationMarks(uuid)  +"\"" : null) + "," + (this.name != null ? "\""+ utilities.scapeQuotationMarks(name)  +"\"" : null) + "," + (this.description != null ? "\""+ utilities.scapeQuotationMarks(description)  +"\"" : null) + "," + (this.reportDesignId == 0 ? null : this.reportDesignId) + "," + (this.contentType != null ? "\""+ utilities.scapeQuotationMarks(contentType)  +"\"" : null) + "," + (this.extension != null ? "\""+ utilities.scapeQuotationMarks(extension)  +"\"" : null) + "," + (this.contents != null ? "\""+contents+"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.retired) + "," + (this.retiredBy == 0 ? null : this.retiredBy) + "," + (this.dateRetired != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateRetired)  +"\"" : null) + "," + (this.retireReason != null ? "\""+ utilities.scapeQuotationMarks(retireReason)  +"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ReportingReportDesignVO.class, this.reportDesignId, false, conn); 
