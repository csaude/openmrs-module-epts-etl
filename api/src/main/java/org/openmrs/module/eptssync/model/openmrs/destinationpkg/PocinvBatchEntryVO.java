...
public class PocinvBatchEntryVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.batchOperationType = rs.getString("batch_operation_type") != null ? rs.getString("batch_operation_type").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.batchId == 0 ? null : this.batchId) + "," + (this.quantity) + "," + (this.batchOperationType != null ? "\""+batchOperationType+"\"" : null) + "," + (this.reversalRequestorId == 0 ? null : this.reversalRequestorId) + "," + (this.reversedId == 0 ? null : this.reversedId) + "," + (this.orderId == 0 ? null : this.orderId) + "," + (this.uuid != null ? "\""+uuid+"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.retired) + "," + (this.retiredBy == 0 ? null : this.retiredBy) + "," + (this.dateRetired != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateRetired)  +"\"" : null) + "," + (this.retireReason != null ? "\""+retireReason+"\"" : null); 
	} 
