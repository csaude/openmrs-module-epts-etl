...
public class NotificationAlertRecipientVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public String generateInsertValues(){ 
 		return ""+(this.userId == 0 ? null : this.userId) + "," + (this.alertRead) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+uuid+"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.NotificationAlertVO.class, this.alertId, false, conn); 
		this.alertId = 0;
