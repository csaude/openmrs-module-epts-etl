...
public class ReportObjectVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.reportObjectType = rs.getString("report_object_type") != null ? rs.getString("report_object_type").trim() : null;
		this.reportObjectSubType = rs.getString("report_object_sub_type") != null ? rs.getString("report_object_sub_type").trim() : null;
		this.xmlData = rs.getString("xml_data") != null ? rs.getString("xml_data").trim() : null;
