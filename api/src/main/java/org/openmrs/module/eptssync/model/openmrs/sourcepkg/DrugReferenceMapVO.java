...
public class DrugReferenceMapVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptMapTypeVO.class, this.conceptMapType, false, conn); 
		this.conceptMapType = 0;
		if (parentOnDestination  != null) this.conceptMapType = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptReferenceTermVO.class, this.termId, false, conn); 
		this.termId = 0;
