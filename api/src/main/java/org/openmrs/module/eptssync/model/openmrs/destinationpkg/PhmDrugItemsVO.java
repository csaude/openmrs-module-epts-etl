...
public class PhmDrugItemsVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.fnmCode = rs.getString("fnm_code") != null ? rs.getString("fnm_code").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.fnmCode != null ? "\""+fnmCode+"\"" : null) + "," + (this.pharmaceuticalFormId == 0 ? null : this.pharmaceuticalFormId) + "," + (this.therapeuticGroupId == 0 ? null : this.therapeuticGroupId) + "," + (this.therapeuticClassId == 0 ? null : this.therapeuticClassId) + "," + (this.uuid != null ? "\""+uuid+"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.retired) + "," + (this.retiredBy == 0 ? null : this.retiredBy) + "," + (this.dateRetired != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateRetired)  +"\"" : null) + "," + (this.retireReason != null ? "\""+retireReason+"\"" : null); 
	} 
