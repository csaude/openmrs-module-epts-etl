...
public class AddressHierarchyAddressToEntryMapVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public String generateInsertValues(){ 
 		return ""+(this.addressId == 0 ? null : this.addressId) + "," + (this.entryId == 0 ? null : this.entryId) + "," + (this.uuid != null ? "\""+uuid+"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.PersonAddressVO.class, this.addressId, false, conn); 
		this.addressId = 0;
		if (parentOnDestination  != null) this.addressId = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.AddressHierarchyEntryVO.class, this.entryId, false, conn); 
		this.entryId = 0;
