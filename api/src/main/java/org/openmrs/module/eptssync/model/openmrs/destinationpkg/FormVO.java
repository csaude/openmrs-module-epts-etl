...
public class FormVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.template = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("template") != null ? rs.getString("template").trim() : null);
		this.xslt = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("xslt") != null ? rs.getString("xslt").trim() : null);
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.EncounterTypeVO.class, this.encounterType, true, conn); 
