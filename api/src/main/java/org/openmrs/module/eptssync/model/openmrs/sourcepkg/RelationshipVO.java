...
public class RelationshipVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.PersonVO.class, this.personA, false, conn); 
		this.personA = 0;
		if (parentOnDestination  != null) this.personA = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.PersonVO.class, this.personB, false, conn); 
		this.personB = 0;
