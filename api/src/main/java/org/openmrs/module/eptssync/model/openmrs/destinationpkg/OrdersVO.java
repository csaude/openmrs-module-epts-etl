...
public class OrdersVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ConceptVO.class, this.orderReason, true, conn); 
		this.orderReason = 0;
		if (parentOnDestination  != null) this.orderReason = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ProviderVO.class, this.orderer, false, conn); 
		this.orderer = 0;
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.CareSettingVO.class, this.careSetting, false, conn); 
		this.careSetting = 0;
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.OrderTypeVO.class, this.orderTypeId, false, conn); 
		this.orderTypeId = 0;
