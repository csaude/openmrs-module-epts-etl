...
public class BahmniConfigVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.configName = rs.getString("config_name") != null ? rs.getString("config_name").trim() : null;
		this.appName = rs.getString("app_name") != null ? rs.getString("app_name").trim() : null;
		this.config = rs.getString("config") != null ? rs.getString("config").trim() : null;
	...
	public String generateInsertValues(){ 
 		return (this.configName != null ? "\""+configName+"\"" : null) + "," + (this.appName != null ? "\""+appName+"\"" : null) + "," + (this.config != null ? "\""+config+"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+uuid+"\"" : null); 
	} 
