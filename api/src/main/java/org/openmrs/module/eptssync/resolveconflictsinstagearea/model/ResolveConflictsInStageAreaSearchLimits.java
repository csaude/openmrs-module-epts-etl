...
public class ResolveConflictsInStageAreaSearchLimits extends RecordLimits {
	...
	private SyncResolveConflictsInStageAreaEngine engine;
	...
	public ResolveConflictsInStageAreaSearchLimits(long firstRecordId, long lastRecordId, SyncResolveConflictsInStageAreaEngine engine) {
	...
	@JsonIgnore
	public SyncResolveConflictsInStageAreaEngine getEngine() {
		return engine;
	}
	...
	public static ResolveConflictsInStageAreaSearchLimits loadFromFile(File file, SyncResolveConflictsInStageAreaEngine engine) {
		try {
