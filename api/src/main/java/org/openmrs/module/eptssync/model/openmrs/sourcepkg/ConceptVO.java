...
public class ConceptVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptDatatypeVO.class, this.datatypeId, false, conn); 
		this.datatypeId = 0;
