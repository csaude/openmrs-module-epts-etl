...
public class ProvidermanagementProviderSuggestionVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.criteria = rs.getString("criteria") != null ? rs.getString("criteria").trim() : null;
		this.evaluator = rs.getString("evaluator") != null ? rs.getString("evaluator").trim() : null;
