...
public class ConceptReferenceTermMapVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptMapTypeVO.class, this.aIsToBId, false, conn); 
		this.aIsToBId = 0;
		if (parentOnDestination  != null) this.aIsToBId = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptReferenceTermVO.class, this.termAId, false, conn); 
		this.termAId = 0;
		if (parentOnDestination  != null) this.termAId = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptReferenceTermVO.class, this.termBId, false, conn); 
		this.termBId = 0;
