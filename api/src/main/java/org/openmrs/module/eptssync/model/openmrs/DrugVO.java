...
public class DrugVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public String generateInsertValues(){ 
 		return (this.conceptId == 0 ? null : this.conceptId) + "," + (this.name != null ? "\""+name+"\"" : null) + "," + (this.combination) + "," + (this.dosageForm == 0 ? null : this.dosageForm) + "," + (this.maximumDailyDose) + "," + (this.minimumDailyDose) + "," + (this.route == 0 ? null : this.route) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.retired) + "," + (this.retiredBy == 0 ? null : this.retiredBy) + "," + (this.dateRetired != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateRetired)  +"\"" : null) + "," + (this.retireReason != null ? "\""+retireReason+"\"" : null) + "," + (this.uuid != null ? "\""+uuid+"\"" : null) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.strength != null ? "\""+strength+"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.ConceptVO.class, this.dosageForm, true, conn); 
		this.dosageForm = 0;
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.ConceptVO.class, this.route, true, conn); 
		this.route = 0;
