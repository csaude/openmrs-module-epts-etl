...
public class ConceptSynonymVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.synonym = rs.getString("synonym") != null ? rs.getString("synonym").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.synonym != null ? "\""+synonym+"\"" : null) + "," + (this.locale != null ? "\""+locale+"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null); 
	} 
