...
public class GaacVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.gaacIdentifier = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("gaac_identifier") != null ? rs.getString("gaac_identifier").trim() : null);
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.GaacAffinityTypeVO.class, this.affinityType, true, conn); 
		this.affinityType = 0;
