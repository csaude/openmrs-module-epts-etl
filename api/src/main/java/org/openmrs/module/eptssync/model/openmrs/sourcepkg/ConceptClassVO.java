...
public class ConceptClassVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void setObjectId(int selfId){ 
		this.conceptClassId = selfId; 
	} 
 
	public void load(ResultSet rs) throws SQLException{ 
		this.conceptClassId = rs.getInt("concept_class_id");
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.name, this.description, this.creator == 0 ? null : this.creator, this.dateCreated, this.retired, this.retiredBy == 0 ? null : this.retiredBy, this.dateRetired, this.retireReason, this.uuid, this.conceptClassId};		return params; 
	} 
 
	@JsonIgnore
	public String getInsertSQL(){ 
 		return "INSERT INTO concept_class(name, description, creator, date_created, retired, retired_by, date_retired, retire_reason, uuid) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	public String getUpdateSQL(){ 
 		return "UPDATE concept_class SET name = ?, description = ?, creator = ?, date_created = ?, retired = ?, retired_by = ?, date_retired = ?, retire_reason = ?, uuid = ? WHERE concept_class_id = ?;"; 
	} 
