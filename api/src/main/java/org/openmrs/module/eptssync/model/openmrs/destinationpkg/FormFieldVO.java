...
public class FormFieldVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.fieldPart = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("field_part") != null ? rs.getString("field_part").trim() : null);
	...
	public String generateInsertValues(){ 
 		return ""+(this.formId == 0 ? null : this.formId) + "," + (this.fieldId == 0 ? null : this.fieldId) + "," + (this.fieldNumber) + "," + (this.fieldPart != null ? "\""+ utilities.scapeQuotationMarks(fieldPart)  +"\"" : null) + "," + (this.pageNumber) + "," + (this.parentFormField == 0 ? null : this.parentFormField) + "," + (this.minOccurs) + "," + (this.maxOccurs) + "," + (this.required) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.sortWeight) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(uuid)  +"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.FieldVO.class, this.fieldId, false, conn); 
		this.fieldId = 0;
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.FormFieldVO.class, this.parentFormField, true, conn); 
