...
public class ConceptStateConversionVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public String generateInsertValues(){ 
 		return ""+(this.conceptId == 0 ? null : this.conceptId) + "," + (this.programWorkflowId == 0 ? null : this.programWorkflowId) + "," + (this.programWorkflowStateId == 0 ? null : this.programWorkflowStateId) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(uuid)  +"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ProgramWorkflowVO.class, this.programWorkflowId, true, conn); 
		this.programWorkflowId = 0;
		if (parentOnDestination  != null) this.programWorkflowId = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ProgramWorkflowStateVO.class, this.programWorkflowStateId, true, conn); 
