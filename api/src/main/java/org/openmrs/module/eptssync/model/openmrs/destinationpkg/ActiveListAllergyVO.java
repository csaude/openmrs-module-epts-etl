...
public class ActiveListAllergyVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.allergyType = rs.getString("allergy_type") != null ? rs.getString("allergy_type").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.allergyType != null ? "\""+allergyType+"\"" : null) + "," + (this.reactionConceptId == 0 ? null : this.reactionConceptId) + "," + (this.severity != null ? "\""+severity+"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ConceptVO.class, this.reactionConceptId, true, conn); 
