...
public class AddressHierarchyEntryVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.AddressHierarchyLevelVO.class, this.levelId, false, conn); 
		this.levelId = 0;
		if (parentOnDestination  != null) this.levelId = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.AddressHierarchyEntryVO.class, this.parentId, true, conn); 
		this.parentId = 0;
