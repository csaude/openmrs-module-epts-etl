...
public class LogicTokenRegistrationVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.token = rs.getString("token") != null ? rs.getString("token").trim() : null;
		this.providerClassName = rs.getString("provider_class_name") != null ? rs.getString("provider_class_name").trim() : null;
		this.providerToken = rs.getString("provider_token") != null ? rs.getString("provider_token").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.token != null ? "\""+token+"\"" : null) + "," + (this.providerClassName != null ? "\""+providerClassName+"\"" : null) + "," + (this.providerToken != null ? "\""+providerToken+"\"" : null) + "," + (this.configuration != null ? "\""+configuration+"\"" : null) + "," + (this.uuid != null ? "\""+uuid+"\"" : null); 
	} 
