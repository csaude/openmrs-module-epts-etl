...
public class GaacFamilyMemberVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.GaacFamilyVO.class, this.familyId, false, conn); 
		this.familyId = 0;
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.RelationshipVO.class, this.familyMemberRelacao, true, conn); 
