...
public class ConceptProposalVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.originalText = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("original_text") != null ? rs.getString("original_text").trim() : null);
		this.finalText = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("final_text") != null ? rs.getString("final_text").trim() : null);
	...
	public String generateInsertValues(){ 
 		return ""+(this.conceptId == 0 ? null : this.conceptId) + "," + (this.encounterId == 0 ? null : this.encounterId) + "," + (this.originalText != null ? "\""+ utilities.scapeQuotationMarks(originalText)  +"\"" : null) + "," + (this.finalText != null ? "\""+ utilities.scapeQuotationMarks(finalText)  +"\"" : null) + "," + (this.obsId == 0 ? null : this.obsId) + "," + (this.obsConceptId == 0 ? null : this.obsConceptId) + "," + (this.state != null ? "\""+ utilities.scapeQuotationMarks(state)  +"\"" : null) + "," + (this.comments != null ? "\""+ utilities.scapeQuotationMarks(comments)  +"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.locale != null ? "\""+ utilities.scapeQuotationMarks(locale)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(uuid)  +"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ConceptVO.class, this.obsConceptId, true, conn); 
		this.obsConceptId = 0;
