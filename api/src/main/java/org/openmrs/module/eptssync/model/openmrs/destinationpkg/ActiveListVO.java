...
public class ActiveListVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ActiveListTypeVO.class, this.activeListTypeId, false, conn); 
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ObsVO.class, this.startObsId, true, conn); 
		this.startObsId = 0;
		if (parentOnDestination  != null) this.startObsId = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ObsVO.class, this.stopObsId, true, conn); 
		this.stopObsId = 0;
