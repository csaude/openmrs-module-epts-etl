...
public class ProviderAttributeVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ProviderAttributeTypeVO.class, this.attributeTypeId, false, conn); 
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ProviderVO.class, this.providerId, false, conn); 
		this.providerId = 0;
