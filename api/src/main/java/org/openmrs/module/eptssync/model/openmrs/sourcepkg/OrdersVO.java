...
public class OrdersVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ConceptVO.class, this.orderReason, true, conn); 
		this.orderReason = 0;
		if (parentOnDestination  != null) this.orderReason = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.ProviderVO.class, this.orderer, false, conn); 
		this.orderer = 0;
		if (parentOnDestination  != null) this.orderer = parentOnDestination.getObjectId();
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.CareSettingVO.class, this.careSetting, false, conn); 
		this.careSetting = 0;
		if (parentOnDestination  != null) this.careSetting = parentOnDestination.getObjectId();
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.OrdersVO.class, this.previousOrderId, true, conn); 
		this.previousOrderId = 0;
		if (parentOnDestination  != null) this.previousOrderId = parentOnDestination.getObjectId();
 
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.OrderTypeVO.class, this.orderTypeId, false, conn); 
		this.orderTypeId = 0;
		if (parentOnDestination  != null) this.orderTypeId = parentOnDestination.getObjectId();
