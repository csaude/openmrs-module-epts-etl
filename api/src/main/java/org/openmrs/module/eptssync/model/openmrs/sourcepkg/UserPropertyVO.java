...
public class UserPropertyVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.property = rs.getString("property") != null ? rs.getString("property").trim() : null;
			} 
	...
	public String generateInsertValues(){ 
 		return ""+(this.userId == 0 ? null : this.userId) + "," + (this.propertyValue != null ? "\""+propertyValue+"\"" : null); 
	} 
