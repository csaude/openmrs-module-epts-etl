...
public class PocinvDeliverNoteItemVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.lotNumber = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("lot_number") != null ? rs.getString("lot_number").trim() : null);
		this.tokenNumber = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("token_number") != null ? rs.getString("token_number").trim() : null);
