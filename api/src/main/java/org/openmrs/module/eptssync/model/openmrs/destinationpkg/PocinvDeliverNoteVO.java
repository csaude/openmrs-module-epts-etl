...
public class PocinvDeliverNoteVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.simamNumber = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("simam_number") != null ? rs.getString("simam_number").trim() : null);
