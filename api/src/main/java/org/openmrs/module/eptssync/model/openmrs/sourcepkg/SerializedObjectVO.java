...
public class SerializedObjectVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.type = rs.getString("type") != null ? rs.getString("type").trim() : null;
		this.subtype = rs.getString("subtype") != null ? rs.getString("subtype").trim() : null;
		this.serializationClass = rs.getString("serialization_class") != null ? rs.getString("serialization_class").trim() : null;
		this.serializedData = rs.getString("serialized_data") != null ? rs.getString("serialized_data").trim() : null;
	...
	public String generateInsertValues(){ 
 		return ""+(this.name != null ? "\""+name+"\"" : null) + "," + (this.description != null ? "\""+description+"\"" : null) + "," + (this.type != null ? "\""+type+"\"" : null) + "," + (this.subtype != null ? "\""+subtype+"\"" : null) + "," + (this.serializationClass != null ? "\""+serializationClass+"\"" : null) + "," + (this.serializedData != null ? "\""+serializedData+"\"" : null) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.retired) + "," + (this.dateRetired != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateRetired)  +"\"" : null) + "," + (this.retiredBy == 0 ? null : this.retiredBy) + "," + (this.retireReason != null ? "\""+retireReason+"\"" : null) + "," + (this.uuid != null ? "\""+uuid+"\"" : null); 
	} 
