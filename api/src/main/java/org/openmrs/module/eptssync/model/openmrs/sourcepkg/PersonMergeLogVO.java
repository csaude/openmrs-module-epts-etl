...
public class PersonMergeLogVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.mergedData = rs.getString("merged_data") != null ? rs.getString("merged_data").trim() : null;
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.PersonVO.class, this.loserPersonId, false, conn); 
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.PersonVO.class, this.winnerPersonId, false, conn); 
