...
public class FieldVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.attributeName = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("attribute_name") != null ? rs.getString("attribute_name").trim() : null);
		this.defaultValue = AttDefinedElements.removeStrangeCharactersOnString(rs.getString("default_value") != null ? rs.getString("default_value").trim() : null);
	...
	public String generateInsertValues(){ 
 		return ""+(this.name != null ? "\""+ utilities.scapeQuotationMarks(name)  +"\"" : null) + "," + (this.description != null ? "\""+ utilities.scapeQuotationMarks(description)  +"\"" : null) + "," + (this.fieldType == 0 ? null : this.fieldType) + "," + (this.conceptId == 0 ? null : this.conceptId) + "," + (this.tableName != null ? "\""+ utilities.scapeQuotationMarks(tableName)  +"\"" : null) + "," + (this.attributeName != null ? "\""+ utilities.scapeQuotationMarks(attributeName)  +"\"" : null) + "," + (this.defaultValue != null ? "\""+ utilities.scapeQuotationMarks(defaultValue)  +"\"" : null) + "," + (this.selectMultiple) + "," + (this.creator == 0 ? null : this.creator) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateCreated)  +"\"" : null) + "," + (this.changedBy == 0 ? null : this.changedBy) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateChanged)  +"\"" : null) + "," + (this.retired) + "," + (this.retiredBy == 0 ? null : this.retiredBy) + "," + (this.dateRetired != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS(dateRetired)  +"\"" : null) + "," + (this.retireReason != null ? "\""+ utilities.scapeQuotationMarks(retireReason)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(uuid)  +"\"" : null); 
	} 
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.sourcepkg.FieldTypeVO.class, this.fieldType, true, conn); 
		this.fieldType = 0;
