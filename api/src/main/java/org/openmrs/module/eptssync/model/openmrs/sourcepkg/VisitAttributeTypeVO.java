...
public class VisitAttributeTypeVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	private int visitAttributeTypeId;
	private String name;
	...
	public void setVisitAttributeTypeId(int visitAttributeTypeId){ 
	 	this.visitAttributeTypeId = visitAttributeTypeId;
	}
 
	public int getVisitAttributeTypeId(){ 
	...
	public void load(ResultSet rs) throws SQLException{ 
		this.visitAttributeTypeId = rs.getInt("visit_attribute_type_id");
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.name, this.description, this.datatype, this.datatypeConfig, this.preferredHandler, this.handlerConfig, this.minOccurs, this.maxOccurs, this.creator == 0 ? null : this.creator, this.dateCreated, this.changedBy == 0 ? null : this.changedBy, this.dateChanged, this.retired, this.retiredBy == 0 ? null : this.retiredBy, this.dateRetired, this.retireReason, this.uuid, this.visitAttributeTypeId};		return params; 
	} 
