...
public class ConceptReferenceTermVO extends AbstractOpenMRSObject implements OpenMRSObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.code = rs.getString("code") != null ? rs.getString("code").trim() : null;
	...
	public void loadDestParentInfo(Connection conn) throws ParentNotYetMigratedException, DBException {
		...
		parentOnDestination = loadParent(org.openmrs.module.eptssync.model.openmrs.destinationpkg.ConceptReferenceSourceVO.class, this.conceptSourceId, false, conn); 
