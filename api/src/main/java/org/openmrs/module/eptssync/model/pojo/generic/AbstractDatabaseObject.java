...
public abstract class AbstractDatabaseObject extends BaseVO implements DatabaseObject {
	...
	public void resolveConflictWithExistingRecord(DatabaseObject recordOnDB, SyncTableConfiguration tableConfiguration,
		...
		if (utilities.arrayHasElement(tableConfiguration.getWinningRecordFieldsInfo())) {
			for (List<org.openmrs.module.eptssync.model.Field> fields : tableConfiguration.getWinningRecordFieldsInfo()) {
				
				//Start assuming that this record is updated
				boolean thisRecordIsUpdated = true;
				
				for (org.openmrs.module.eptssync.model.Field field : fields) {
