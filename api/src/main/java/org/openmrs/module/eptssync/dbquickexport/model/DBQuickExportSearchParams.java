...
public class DBQuickExportSearchParams extends SyncSearchParams<OpenMRSObject>{
	...
	public DBQuickExportSearchParams(SyncTableConfiguration tableInfo, RecordLimits limits, Connection conn) {
	...
	public int countAllRecords(Connection conn) throws DBException {
		DBQuickExportSearchParams auxSearchParams = new DBQuickExportSearchParams(this.tableInfo, this.limits, conn);
